      ...
      <div className="container-fluid mt-3">
                    ...
                    <div className="d-flex align-items-center w-100 justify-content-between">
                      <div className="flex-grow-1 overflow-hidden">
                        ...
                        <h5 className="text-success fs-14 mb-0">
                          <CountUp
                            finalValue={metrics?.activeBatchesCount}
                            duration={500}
                          />
                        </h5>
                  ...
                  <div className="card-body my-2">
                    <div className="d-flex align-items-center w-100 justify-content-between">
                      <div className="flex-grow-1 overflow-hidden">
                        ...
                        <h5 className="text-success fs-14 mb-0">
                          <CountUp
                            finalValue={metrics?.upcomingBatchesCount}
                            duration={500}
                          />
                        </h5>
                        <p className="fs-12 text-mute">
                  ...
                  <div className="card-body my-2">
                    <div className="d-flex align-items-center w-100 justify-content-between">
                      <div className="flex-grow-1 overflow-hidden">
                        ...
                        <h5 className="text-success fs-14 mb-0">
                          <CountUp
                            finalValue={metrics?.trainerCount}
                            duration={500}
                          />
                        </h5>
                        <p className="fs-12 text-mute">Total No. of Trainers</p>
                      </div>
                      <div className="flex-shrink-0">
                        <div className="avatar-md-batch me-3">
                          <span className="avatar-title-batch batch_bg rounded-circle fs-1">
                  ...
                  <div className="card-body my-2">
                    <div className="d-flex align-items-center w-100 justify-content-between">
                      <div className="flex-grow-1 overflow-hidden">
                        ...
                        <h5 className="text-success fs-14 mb-0">
                          <CountUp
                            finalValue={metrics?.studentCount}
                            duration={500}
                          />
                        </h5>
                        <p className="fs-12 text-mute">
          ...
          <div className="col-lg-6">
            <div className="card">
              <div className="card-body">
                ...
                <GraphOne batchInfo={batchInfo} branches={branches} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="card">
              <div className="card-body">
                <GraphThree branches={branches} batchcount={batchCount} />
              </div>
            </div>
          </div>
        </div>
        <div className="card">
          <div className="card-body">
            <UpcomingBatchesList UpcomingBatchesList={upcomingBatches} />
          </div>
        </div>
      </div>
      {showModal1 === true && batchID === null && (
        <AddBatch
          curriculumData={curriculums?.reversedCurriculums}
          branchData={branches}
          show={showModal1}
