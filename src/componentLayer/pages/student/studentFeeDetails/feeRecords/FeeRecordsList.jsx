...
const FeeRecordsList = () => {
    ...
    const columns = [
        {
            ...
            header: "S.No",
            accessor: (row, index) =>
                (FeeRecordsList?.currentPage - 1) * FeeRecordsList?.pageSize + index + 1,
        },
        {
            id: "name",
            header: "Name",
            accessor: (row) => (
                <Link to={`/student/feeUpdate?studentId=${row.id}`}>
                    {row.name}
                </Link>
            ),
            sortable: true,
        ...
        },
        {
            ...
            header: "Lead Source",
            accessor: (row) =>
                row.leadsource?.length > 0 ? row.leadsource[0].source : "-",
            sortable: true,
            hideable: true,
        },
        {
        ...
        },
        {
            ...
            header: "Due Date",
            accessor: (row) =>
                row.nextduedate ?  row.nextduedate : "-",
            sortable: true,
            hideable: true,
        },
        {
        ...
        },
        {
            ...
            header: "Installments",
            accessor: (row) =>
                row.totalinstallments?.length > 0
    ...
    const FeeRecordData = FeeRecordsList?.students?.map((item) => ({
        ...item,
        rawItem: item,
    })) || [];
                                                    ...
                                                    return (
                                                        <tr key={index + 1}>
                                                            ...
                                                            <td className="fs-13 black_300  lh-xs bg_light text-truncate" style={{ maxWidth: "150px" }}
                                                                title={item?.leadsource && item?.leadsource.length > 0
