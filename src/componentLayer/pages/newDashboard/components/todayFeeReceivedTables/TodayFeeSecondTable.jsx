...
const TodayFeeSecondTable = ({
  handleCouncellorIdTodayFeeRecevied,
  activeCouncellorTodayFeeRecevied,
  todayFeeCounsellorList = []
}) => {
  /* =========================
     DATA
  ========================= */
  const tableData = useMemo(() => {
    return todayFeeCounsellorList || [];
  }, [todayFeeCounsellorList]);
      ...
      },
      {
        ...
        accessor: (row) => (
          <span
            ...
            onClick={() =>
              handleCouncellorIdTodayFeeRecevied(row?.user_id)
            }
          >
            {row?.enquirytakenby}
          </span>
...
export default TodayFeeSecondTable;
...
//                                         <tbody>
//                                             {todayFeeCounsellorList &&
//                                                 todayFeeCounsellorList.length >
//                                                 0 ? (
//                                                 todayFeeCounsellorList?.map(
//                                                     (item, index) => {
//                                                         return (
//                                                             <tr
//                                                                 key={index}
