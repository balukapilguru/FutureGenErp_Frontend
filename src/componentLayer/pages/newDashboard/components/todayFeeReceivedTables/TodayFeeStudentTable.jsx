...
const TodayFeeStudentTable = ({ TodayFeeStudentTableData = [] }) => {
  /* =========================
     DATA
  ========================= */
  const tableData = useMemo(() => {
    return TodayFeeStudentTableData || [];
  }, [TodayFeeStudentTableData]);
      ...
      <div className="col-12">
        <div className="card">
          <div className="card-header">
            <h6>Today Fee Received Student Details</h6>
          </div>
...
export default TodayFeeStudentTable;
...
//         <>
//             {TodayFeeStudentTableData &&
//                 TodayFeeStudentTableData.length >
//                 0 && (
//                     <div className="row">
...
//                                                 <tbody>
//                                                     {TodayFeeStudentTableData &&
//                                                         TodayFeeStudentTableData?.length > 0 ? (
//                                                         TodayFeeStudentTableData?.map(
//                                                             (item, index) => {
//                                                                 return (
//                                                                     <tr key={index}>
